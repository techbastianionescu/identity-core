...
import { LogOut, UserCircle, Mail, Shield, Hash } from "lucide-react"
...
export default function MePage() {
  ...
  const roleName =
    user?.role_id != null ? roles.find((r) => r.id === user.role_id)?.name ?? `id:${user.role_id}` : null
  ...
  return (
    <>
      <PageHeader title="Mi perfil" description="Datos de tu cuenta" />
